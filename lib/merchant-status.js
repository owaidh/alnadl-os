...
//
// «الشريك التجاري» هنا هو merchant: المطعم أو المقهى أو العلامة التي تبيع
// عبر موقع الشريك المضيف. وهو **ليس** الشريك المستضيف (partners)، ولذلك لا
// يُدار بنفس lib/partner-status.js: إغلاق فندق قرار تعاقدي مع النادل،
// وإغلاق مطعم داخل الفندق قرار تشغيلي يتخذه الفندق نفسه. خلطهما كان سيعني
// أن إيقاف مطعم واحد يُسقط الموقع كله.
//
